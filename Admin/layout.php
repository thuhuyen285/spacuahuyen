  ...
  <div class="sidebar">
    ...
    <div id="list">
      <ul class="nav flex-column">
        <li class="nav-item"><a href="index.html" class="nav-link active" ><i class="fa fa-adjust"></i>ADMIN</a></li>
        ...
        <li class="nav-item"><a href="<?=ADMIN_URL?>/index.php?ctrl=dienthoai&act=addnew" class="nav-link"><i class="fa fa-user"></i>Thêm điện thoại </a></li>
        <li class="nav-item"><a href="<?=ADMIN_URL?>/index.php?ctrl=dienthoai&act=index" class="nav-link"><i class="fa fa-table"></i>Danh sách điện thoại</a></li>
